...
export const apiGroups = [
  { id: 'import', en: 'Import & repair', zh: '导入与纠错', apis: ['runRepairWorker', 'runReportWorker', 'repairImport', 'runImportWorker', 'installImportWorker', 'serializeImportTemplate', 'parseImportTemplate', 'importWithTemplate', 'importFile', 'prepareImport', 'mapImportHeaders', 'locateImportCell', 'exportImportReport'] },
